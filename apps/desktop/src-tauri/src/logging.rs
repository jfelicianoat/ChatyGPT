...
pub fn error_kind(error: &AppError) -> FieldValue {
    let kind = match error {
        ...
        AppError::InvalidAthenaUrl(_) => "invalid_athena_url",
        AppError::AthenaTransport(_) => "athena_transport",
        AppError::AthenaResponse { .. } => "athena_response",
        AppError::AthenaContract(_) => "athena_contract",
        AppError::AthenaUnauthorized => "athena_unauthorized",
        AppError::AthenaNotController => "athena_not_controller",
        AppError::AthenaAlreadyResolved => "athena_already_resolved",
        AppError::AthenaRequestGone => "athena_request_gone",
        AppError::AthenaArtifactExpired(_) => "athena_artifact_expired",
